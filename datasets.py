...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR':
        ...
        if not args.use_mcloader:
            ...
            ann_file = os.path.join(args.data_path, 'train.txt' if is_train else 'val_.txt')
            if os.path.exists(ann_file):
                print('using ImageNetDataset...')
                dataset = ImageNetDataset(root, transform=transform, ann_file=ann_file)
            else:
